...
public class ScriptTest {
    ...
    private Script parseScriptString(String string) throws IOException {
        ...
        for(String w : words) {
            ...
            if (w.matches("^-?[0-9]*$")) {
                ...
                Script.writeBytes(out, w.substring(1, w.length() - 1).getBytes("UTF-8"));
    ...
    public void dataDrivenScripts() throws Exception {
        JsonNode json = new ObjectMapper()
                .readTree(new InputStreamReader(getClass().getResourceAsStream("script_tests.json"), "UTF-8"));
